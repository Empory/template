                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        ...
                                        elseif(isset($_COOKIE["cerez"])){
                                            $sorgu = $baglanti->prepare("SELECT username,yetki FROM users WHERE aktif = 1");
                                            $sorgu->execute();
                                            while($sonuc = $sorgu->fetch()) {
                                                if ($_COOKIE['cerez'] == md5("aa{$username}bb")) {
                                                    $_SESSION['login'] = true;
                                        ...
                                        <form method="post" action="login.php">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-4" id="inputEmailAddress" name="username" value="<?= @$username?>" type="text" placeholder="Enter email username" />
                                            </div>
                                            <div class="form-group">
